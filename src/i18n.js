  ...
  gb: {
    translation: {
      description: {
		  ...
		  prague: "Prague, capital city of the Czech Republic, is bisected by the Vltava River. Nicknamed “the City of a Hundred Spires,” it's known for its Old Town Square, the heart of its historic core, with colorful baroque buildings, Gothic churches and the medieval Astronomical Clock, which gives an animated hourly show.+ Prag, die Hauptstadt der Tschechischen Republik, wird von der Moldau durchschnitten. Die Stadt mit dem Spitznamen „die Stadt der hundert Türme“ ist bekannt für ihren Altstädter Ring, das Herz des historischen Kerns, mit farbenfrohen Barockgebäuden, gotischen Kirchen und der mittelalterlichen astronomischen Uhr, die stündlich eine animierte Show bietet.+Prague, capitale de la République tchèque, est traversée par la rivière Vltava. Surnommée « la ville aux cent flèches », elle est connue pour sa place de la vieille ville, le cœur de son centre historique, avec ses bâtiments baroques colorés, ses églises gothiques et l'horloge astronomique médiévale, qui donne un spectacle animé toutes les heures.+Praga, Chexiya Respublikasining poytaxti Vltava daryosi bilan ikkiga bo'lingan. “Yuz shpillar shahri” laqabini olgan bu shahar oʻzining tarixiy markazining yuragi boʻlgan Eski shahar maydoni, rang-barang barokko binolari, gotika cherkovlari va animatsion soatlik shoularni taqdim etuvchi oʻrta asr astronomik soati bilan mashhur."
	  }
    }
  },
  uz: {
    translation: {
      description: {
		  ...
		  howtouse: "Ushbu sayt sizga tashrif buyurish uchun ideal orzu joyingizni topish imkonini beradi. Siz orzu qilgan sayohat saytingizni qit'alar bo'yicha yoki qidirilayotgan joyda bo'lishni xohlagan landshaft turlarini tanlab topishingiz mumkin. Misol uchun, agar siz Yevropa yoki Osiyoda joylashgan va osmono‘par binolari, plyajlari va tarixiy bo‘lishi kerak bo‘lgan joyni topmoqchi bo‘lsangiz, “FIND BY BY CONTINENTS”dan Yevropa va Osiyoni tanlab, osmono‘par binolar, plyaj va tarixiy tugmalarni tanlashingiz kerak - Qit'a bo'yicha toping dan. Agar ushbu talablarga ega bo'lgan joy(lar) mavjud bo'lsa, ularni hisobingizda saqlashni yoqtirishingiz mumkin. E'tibor bering, siz qidirayotgan joy bizning ma'lumotlar bazasida bo'lmasligi mumkin",
		  
		  aboutme: "Men Muxammadjon Jalolov bu sayt yaratuvchisiman. Men Fransiyaning Lotaringiya universitetida kompyuter fanlari bo‘yicha magistr darajasiga egaman. Ko'p joylarga sayohat qilish meni ushbu saytni yaratishga undadi. Men siz xohlagan turga o'xshash sayohat joylarini topadigan veb-xizmat yaratmoqchi edim. Ba'zida odamlar bizga juda yaqin bo'lgan ko'plab ajoyib yo'nalishlar haqida bilmasligi mumkin yoki biz bunday joylar mavjudligini tasavvur ham qilmaganmiz. Ushbu saytdan foydalanish odamlarga sayohat istaklari ro'yxatini to'ldirishga va orzu qilgan sayohat manzilini topishga yordam beradi.",
		  
		  traveling: "“Overturizm” so‘zi shu qadar yangiki, u hali ko‘pchilik lug‘atlarda uchramaydi (garchi u 2018-yilda “Yil so‘zi” ro‘yxatiga kiritilgan bo‘lsa ham). Ammo bu atamaning yangiligi uning ma'nosi ta'sirini kamaytirmadi: Mashhur yo'nalish yoki diqqatga sazovor joylarga sayyohlarning haddan tashqari ko'p tashrif buyurishi, bu mahalliy atrof-muhit va tarixiy obidalarga zarar yetkazadi va aholining hayot sifatini yomonlashtiradi. Oksford lug'atining qisqa ro'yxatiga. (Qanday qilib overturizmni barqaror global turizmga aylantirish haqida koʻproq oʻqing.) Sayohatchilar, baʼzan toʻsatdan, 1,4 milliardga yaqin boshqa sayyohlarning dunyoning eng jozibali manzillariga qoʻshilish muammolaridan uygʻonishlari bilan, haddan tashqari turizmning tahdidlari va oqibatlari tobora kuchayib bormoqda. har kuni ko'rinadi. BMT Jahon sayyohlik tashkiloti davlat va xususiy sektor hamkorlari bilan birgalikda 27-sentabrni Butunjahon turizm kuni deb e’lon qildi va turizmning ijtimoiy, siyosiy, iqtisodiy va atrof-muhitga ta’sirini muhokama qilish uchun ushbu platformadan foydalanadi. Bu kun barqaror turizm muhimligini ta'kidlaydi - sayohatchilarni va umuman sayyohlik sanoatini atrof-muhitni muhofaza qilish, iqlim o'zgarishiga qarshi kurashish, plastmassa iste'molini minimallashtirish va turizmdan ta'sirlangan jamoalarda iqtisodiy rivojlanishni kengaytirishni o'z ichiga olgan maqsadlarni qo'llab-quvvatlashga jalb qilish uchun asos. "
	  }
    }
  },
  de: {
